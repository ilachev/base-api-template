 ...
 * This is a standalone version that does not depend on the Generator interface.
 */
final class StandaloneHydratorGenerator
{
     ...
     */
    public function generate(ClassMapping $mapping, string $outputDir, string $namespace = 'App\\Infrastructure\\Hydrator'): string
    {
